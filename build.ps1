...
try {
    ...
    Compress-Archive -Path .\dist\package\* -DestinationPath .\dist\PlayerInventoryStacks-1.0.2.zip -Force
    ...
    Compress-Archive -Path .\dist\source\* -DestinationPath .\dist\PlayerInventoryStacks-1.0.2-source.zip -Force
    Get-FileHash -Algorithm SHA256 -LiteralPath .\dist\PlayerInventoryStacks-1.0.2.zip,.\dist\PlayerInventoryStacks.dll,.\dist\PlayerInventoryStacks-1.0.2-source.zip |
